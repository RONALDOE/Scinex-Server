...
router.get("/category/:category", (req, res) => {
 ...
 // Ruta para obtener los posts populares con información de interacción del usuario
router.get("/popular", (req, res) => {
  ...
  const sql = `
    SELECT p.*, 
           ...
           u.username,
           u.badge,
           IF(sp.userId IS NOT NULL, true, false) AS saved,
           IF(l.userId IS NOT NULL, true, false) AS liked
    FROM Posts p
